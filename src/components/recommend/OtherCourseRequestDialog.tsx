...
/** What actually got sent, so the caller can word its confirmation correctly. */
export interface OtherCourseSubmitResult {
...
export interface OtherCourseRequestDialogProps {
  ...
  guruEmail: string;
  onClose: () => void;
  onSubmitted: (result: OtherCourseSubmitResult) => void;
}
