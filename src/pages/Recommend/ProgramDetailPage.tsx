      ...
      >
        ...
        >
          ...
          <Typography sx={{ fontSize: 13, lineHeight: 1.45, ...clampLines(8) }}>
            {renderRichText(displayMessageFor(asset))}
          </Typography>
  ...
  const renderEmail = (asset: Collateral) => (
    <Box sx={{ borderRadius: "10px", overflow: "hidden", border: "1px solid", borderColor: "divider", bgcolor: "background.paper" }}>
      <Box sx={{ p: 1.5, borderBottom: "1px solid", borderColor: "divider" }}>
        <Typography sx={{ fontSize: 15, fontWeight: 700, lineHeight: 1.3 }}>{emailSubjectFor(asset.id)}</Typography>
