 ...
 *
 *   Highlights that sell being taught by the named faculty ("Learn from MIT
 *   faculty", "Designed and delivered by IIT Bombay faculty") are left out: a
 *   guru's referral page is not the place to make claims about who teaches. The
 *   filter drops the whole highlight rather than editing the sentence, so what
 *   remains is still the page's own words. Re-apply it when re-pulling.
 *
